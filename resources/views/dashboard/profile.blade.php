                ...
                <form class="space-y-6">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" value="John" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                        <div>
                            <label class="block text-sm font-medium text-gray-700">Last Name</label>
                            <input type="text" value="Doe" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                        </div>
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700">Email Address</label>
                        <input type="email" value="john@example.com" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700">Company</label>
                        <input type="text" value="Acme Corp" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700">Bio</label>
                        <textarea rows="3" placeholder="Tell us about yourself..." class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500"></textarea>
                    </div>
                    <div>
            ...
            <div class="bg-white shadow rounded-lg p-6 mb-6">
                ...
                <form class="space-y-6">
                    <div>
                        ...
                        <input type="password" class="mt-1 block w-full px-3 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500">
                    </div>
                    <div>
        ...
        <div class="space-y-6">
            ...
            <div class="bg-white shadow rounded-lg p-6">
                ...
                <div class="space-y-4">
                    <div class="flex justify-between">
                        <span class="text-sm text-gray-600">Total Analyses</span>
                        <span class="text-sm font-medium text-gray-900">47</span>
                    </div>
                    <div class="flex justify-between">
                        <span class="text-sm text-gray-600">API Requests</span>
                        <span class="text-sm font-medium text-gray-900">1,589</span>
                    </div>
                    <div class="flex justify-between">
                ...
                <div class="space-y-4">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-sm text-gray-500">Receive analysis results via email</p>
                        </div>
                    ...
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-sm text-gray-500">Get weekly SEO summary reports</p>
                        </div>
                        <input type="checkbox" checked class="h-4 w-4 text-indigo-600 focus:ring-indigo-500 border-gray-300 rounded">
                    </div>
                    <div class="flex items-center justify-between">
            ...
            <div class="bg-white shadow rounded-lg p-6">
                ...
                <div class="text-center py-4">
                    ...
                    <div class="text-sm text-gray-500">100 analyses/month</div>
                    <div class="mt-4">
                        <div class="text-sm text-gray-600">Usage this month</div>
                        <div class="w-full bg-gray-200 rounded-full h-2 mt-2">
                            <div class="bg-indigo-600 h-2 rounded-full" style="width: 47%"></div>
                        </div>
                        <div class="text-sm text-gray-500 mt-1">47 / 100 used</div>
                    </div>
            ...
            <div class="bg-white shadow rounded-lg p-6 border border-red-200">
                ...
                <div class="space-y-4">
                    <div>
                        ...
                        <p class="text-sm text-gray-500 mb-2">Download all your analysis data</p>
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-500 mb-2">Permanently delete your account and all data</p>
