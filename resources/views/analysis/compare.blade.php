        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                <div class="flex justify-between items-start">
                    <div>
                        <h1 class="text-3xl font-bold text-gray-900">{{ __('analysis.compare_title') }}</h1>
                        <p class="mt-2 text-gray-600">{{ __('analysis.compare_subtitle') }}</p>
                    </div>
            ...
            <div class="bg-white shadow-sm rounded-lg mb-8">
                <div class="p-6">
                    ...
                    <form method="GET" action="{{ route('analysis.export-comparison-pdf') }}" class="space-y-4 sm:space-y-0 sm:flex sm:items-end sm:space-x-4">
                        ...
                        <div class="flex-1">
                            <label for="analysis2" class="block text-sm font-medium text-gray-700">{{ __('analysis.second_analysis') }}</label>
                            ...
                            @if($comparison)
                                <form method="POST" action="{{ route('analysis.export-comparison-pdf') }}" class="inline">
                                    ...
                                    <button type="submit"
                                        ...
                                        {{ __('analysis.export_comparison_pdf') }}
                                    </button>
                                </form>
                            @endif
                        </div>
            ...
            @if($comparison)
                ...
                <div class="space-y-8">
                        ...
                        <div class="p-6">
                            ...
                            <div class="mt-8 pt-6 border-t border-gray-200">
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    ...
                                    @endphp
                                    <div class="text-center">
                                        <div class="text-sm text-gray-600">{{ __('analysis.overall') }}</div>
                                    ...
                                    @endphp
                                    <div class="text-center">
                                        <div class="text-sm text-gray-600">{{ __('analysis.technical_seo') }}</div>
                                    ...
                                    @endphp
                                    <div class="text-center">
                                        <div class="text-sm text-gray-600">{{ __('analysis.content') }}</div>
                                    ...
                                    @endphp
                                    <div class="text-center">
                                        <div class="text-sm text-gray-600">{{ __('analysis.performance') }}</div>
                            ...
                            <div class="p-6">
                                ...
                                <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                                    ...
                                    <div>
                                        ...
                                        <div class="space-y-4">
                                            <div>
                                                <h4 class="text-sm font-medium text-gray-600 mb-2">{{ __('analysis.title') }}</h4>
                                            ...
                                            <div>
                                                <h4 class="text-sm font-medium text-gray-600 mb-2">{{ __('analysis.description') }}</h4>
                                                <p class="text-sm text-gray-900 bg-gray-50 p-3 rounded">
                    ...
                    @if(isset($comparison['data1']['crawl_data']) && isset($comparison['data2']['crawl_data']))
                        <div class="bg-white shadow-sm rounded-lg">
                            <div class="p-6">
                                <h2 class="text-lg font-medium text-gray-900 mb-6">{{ __('analysis.technical_comparison') }}</h2>
                                <div class="overflow-x-auto">
                                    <table class="min-w-full divide-y divide-gray-200">
                                        <thead class="bg-gray-50">
                                            <tr>
                                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{{ __('analysis.metric') }}</th>
                                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{{ __('analysis.analysis_1') }}</th>
                                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{{ __('analysis.analysis_2') }}</th>
                                                <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">{{ __('analysis.difference') }}</th>
                                            </tr>
                                        </thead>
                                        <tbody class="bg-white divide-y divide-gray-200">
                                            <tr>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{{ __('analysis.page_size') }}</td>
                                            ...
                                            <tr>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">{{ __('analysis.load_time') }}</td>
                                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
            ...
            @else
                @if($availableAnalyses->count() < 2)
                    <div class="text-center py-12">
                        ...
                        <h3 class="mt-2 text-sm font-medium text-gray-900">{{ __('analysis.not_enough_analyses') }}</h3>
                        <p class="mt-1 text-sm text-gray-500">{{ __('analysis.need_two_analyses') }}</p>
                        <div class="mt-6">
                ...
                @else
                    <div class="text-center py-12">
                        ...
                        <h3 class="mt-2 text-sm font-medium text-gray-900">{{ __('analysis.select_to_compare') }}</h3>
                        <p class="mt-1 text-sm text-gray-500">{{ __('analysis.choose_two_analyses') }}</p>
                    </div>
                @endif
            @endif
        </div>
